...
RSpec.describe SpacesTable do
  ...
  it "gets a single space" do
    db = clean_and_get_database
    spaces_table = SpacesTable.new(db)
    space1 = spaces_table.add(SpaceEntity.new("my_title", 200, "my_description",Date.parse('2022-02-03'),Date.parse('2023-03-04'), 65))
    space2 = spaces_table.add(SpaceEntity.new("moon_base",1000,"lunar phase",Date.parse('2022-11-07'), Date.parse('2022-11-30'), 808))
    space3 = spaces_table.add(SpaceEntity.new("my_title_2", 300, "my_description_2",Date.parse('4000-02-03'),Date.parse('4002-03-04'), 47))
